 ...
 */
export const QUEUES = { alerts: 'alerts', notify: 'notify', wooSync: 'woo-sync', auditReport: 'audit-report', auditPurge: 'audit-purge', brandTranslate: 'brand-translate', mediaLocalize: 'media-localize', analyticsPurge: 'analytics-purge', reviewRequest: 'review-request', abandonedCart: 'abandoned-cart', lotExpiry: 'lot-expiry', loyaltyStanding: 'loyalty-standing', stocktakeCycle: 'stocktake-cycle', gscSitemap: 'gsc-sitemap' } as const;
