 ...
 */
export const QUEUES = { alerts: 'alerts', notify: 'notify', wooSync: 'woo-sync', auditReport: 'audit-report', auditPurge: 'audit-purge', brandTranslate: 'brand-translate' } as const;
