...
const FIELDS: FieldSpec[] = [
  ...
  { name: 'type', label: 'النوع', type: 'text', hint: 'مثال: مخزن، مكتب' },
  { name: 'isUltraFastZone', label: 'منطقة UltraFast', type: 'checkbox' },
];
...
export default async function LocationEditPage({ params }: { params: Promise<{ locale: string; id?: string[] }> }) {
  ...
  return (
    <div className="p-6">
      <h1 className="mb-6 font-heading text-xl font-semibold">{locationId ? 'تعديل الموقع' : 'موقع جديد'}</h1>
