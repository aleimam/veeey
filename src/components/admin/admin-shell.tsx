...
import {
  ...
  PanelLeftOpen, Sun, Moon, LogOut, ExternalLink, ChevronRight, KeyRound, Cable, DatabaseZap, RefreshCw, Trash2, CreditCard,
} from 'lucide-react';
...
const ICONS: Record<string, LucideIcon> = {
  ...
  providers: Plug, appearance: Palette, loginProviders: KeyRound, integration: Webhook, payments: CreditCard,
