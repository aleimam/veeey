...
import {
  ...
  PanelLeftOpen, Sun, Moon, LogOut, ExternalLink, ChevronRight, KeyRound, Cable, DatabaseZap, RefreshCw, Trash2, CreditCard, ListChecks, Rocket, LayoutTemplate, History, Bot, Inbox, LineChart, MessageCircleQuestion, Gauge, ClipboardList, CalendarClock, SearchCheck, ShoppingBag, Stamp, Droplets, TrendingUp,
} from 'lucide-react';
...
export const ICONS: Record<string, LucideIcon> = {
  ...
  providers: Plug, appearance: Palette, branding: Stamp, watermark: Droplets, loginProviders: KeyRound, integration: Webhook, payments: CreditCard, orderStatuses: ListChecks, goLive: Rocket, seoHealth: Gauge, changeLog: History, aiKeys: Bot, aiApprovals: Inbox, google: LineChart,
