...
import {
  ...
  PanelLeftOpen, Sun, Moon, LogOut, ExternalLink, ChevronRight, KeyRound, Cable,
} from 'lucide-react';
...
const ICONS: Record<string, LucideIcon> = {
  ...
  wooConnection: Cable, wooProducts: Package, wooCustomers: Users, wooOrders: ShoppingCart,
};
