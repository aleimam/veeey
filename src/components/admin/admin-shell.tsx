...
import {
  ...
  PanelLeftOpen, Sun, Moon, LogOut, ExternalLink, ChevronRight, KeyRound, Cable, DatabaseZap, RefreshCw, Trash2, CreditCard, ListChecks, Rocket, LayoutTemplate, History, Bot, Inbox, LineChart, MessageCircleQuestion, Gauge, ClipboardList, CalendarClock,
} from 'lucide-react';
...
const ICONS: Record<string, LucideIcon> = {
  ...
  reorderRequests: ClipboardList, expiryFight: CalendarClock,
