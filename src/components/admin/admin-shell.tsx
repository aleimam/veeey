...
export const ICONS: Record<string, LucideIcon> = {
  ...
  providers: Plug, trustpilot: Star, appearance: Palette, branding: Stamp, watermark: Droplets, loginProviders: KeyRound, integration: Webhook, payments: CreditCard, orderStatuses: ListChecks, goLive: Rocket, seoHealth: Gauge, changeLog: History, errorLog: TriangleAlert, backup: HardDriveDownload, aiKeys: Bot, aiApprovals: Inbox, google: LineChart,
